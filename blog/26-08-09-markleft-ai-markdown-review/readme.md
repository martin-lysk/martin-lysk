...
1. Drag this link: [Open in M←](javascript:\(\(\)=%3E%7Bconst%20s=document.createElement\(%22script%22\);s.src=%22https://martin-lysk.github.io/markleft/bookmark.js?%22+Date.now\(\);document.documentElement.append\(s\)%7D\)\(\)) into chromes bookmark bar.
